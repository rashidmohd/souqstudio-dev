...
export const STRUCTURE_NOTE: Readonly<Record<string, string>> = {
  stacked:
    'Packshot on top, brand and name under it, price at the trailing end of the foot.',
  topRibbon:
    'A solid coloured bar across the top of the card naming the promotion, and a solid block of colour holding the price near the foot.',
  dealFrame:
    'Solid coloured bars across both the top and the bottom of the card, with the price sitting inside the bottom bar.',
  pricePill:
    'A tinted panel behind the packshot and the price in a filled rounded pill, with a struck-through old price next to it.',
