 ...
 */
// A shop's brand colours are data on its kit, not chrome, so the token rule
// does not govern them (CLAUDE.md, "A colour a shop owner picked"). These are
// that data's starting values.
